...
namespace MultiShop.IdentityServer
{
    public static class Config
    {
        ...
        {
            new ApiScope("CatalogFullPermission","Full authority for cattalog operations"),
            new ApiScope("CatalogReadPermission","Reading authority for cattalog operations"),
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ...
                ClientSecrets = {new Secret("multishopscret".Sha256())},
            ...
            new Client
            {
                ...
                ClientSecrets = {new Secret("multishopscret".Sha256())},
                AllowedScopes = { "CatalogFullPermission", "CatalogReadPermission", "BasketFullPermission", "OcelotFullPermission", "CommentFullPermission", "PaymentFullPermission", "ImagesFullPermission","DiscountFullPermission",
